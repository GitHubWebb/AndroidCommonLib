 ...
 */
package com.framelibrary.ui.widget.wheelview.adapter.wheelview.adapter;
 ...
 */
public abstract class AbstractWheelTextAdapterChild extends AbstractWheelAdapter {
	 ...
	 *            the current context
	 */
	protected AbstractWheelTextAdapterChild(Context context) {
	 ...
	 */
	private AbstractWheelTextAdapterChild(Context context, int itemResource) {
	 ...
	 */
	protected AbstractWheelTextAdapterChild(Context context, int itemResource, int itemTextResource, int currentIndex,
