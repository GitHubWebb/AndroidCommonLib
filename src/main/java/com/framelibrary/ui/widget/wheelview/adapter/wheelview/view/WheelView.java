...
package com.framelibrary.ui.widget.wheelview.adapter.wheelview.view;
...
import com.framelibrary.ui.widget.wheelview.adapter.wheelview.ItemsRange;
import com.framelibrary.ui.widget.wheelview.adapter.wheelview.adapter.WheelViewAdapter;
import com.framelibrary.ui.widget.wheelview.adapter.wheelview.listener.OnWheelChangedListener;
import com.framelibrary.ui.widget.wheelview.adapter.wheelview.listener.OnWheelClickedListener;
...
//		paint.setStrokeWidth((float) 3);
	...
	private void doScroll(int delta) {
		...
		if (isCyclic && itemCount > 0) {
			...
			// fix viewHolderPosition by rotating
			while (pos < 0) {
				pos += itemCount;
			}
			pos %= itemCount;
